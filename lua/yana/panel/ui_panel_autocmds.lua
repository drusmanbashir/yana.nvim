...
-- deps.focus: the panel's tracked-focus owner. deps.depth: its rebuild-count owner.
        ...
        log.guard("yana.ui panel WinClosed", function()
          ...
          vim.schedule(function()
            log.guard("yana.ui panel WinClosed cleanup", function()
              pcall(require("yana.panel.ui_review_buttons").detach_windows, vtab, p)
